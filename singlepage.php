...
require_once 'db.php';
require_once 'spininformation.php';
...
<title>CreativeHub</title>
    ...
    <meta property="og:title" content="<?= $currentInformation[0]['card_title'] ?>">
    <meta property="og:description" content="<?= $currentInformation[0]['og_description'] ?>">
    <meta property="og:url" content="<?= $currentInformation[0]['og_url'] ?>">   
    <meta property="og:image" content="img/<?= $currentInformation[0]['og_img'] ?>">
...
<button onclick="topFunction()" id="myBtnScroll" title="Go to top"> <img src="Images/arrow.png"></button>
    ...
    <div class="container" style="padding-bottom:10%">
        <div class="row" style="padding-top:10%; padding-bottom:10%">
            ...
            <div class="col-md-6">
                <h1 style="font-weight:800"><?= $currentInformation[0]['card_title'] ?></h1>
                <h6><?= $currentInformation[0]['sp_card_text'] ?></h6>
            </div>
            <div class="col-md-6 sp-img"><img src="img/<?= $currentInformation[0]['img'] ?>" alt=""></div>

        </div class="row">
        <div class="blog-text">
            <?= $currentInformation[0]['sp_info'] ?>
        </div>
    </div>
        ...
        <div class="row" style="padding: 30px 0 10px 0;">
            <div class="col-md-4 text-center">
                <ul style="list-style-type: none;">
                    ...
                    <li id="socialmedia"> <a href="https://www.facebook.com/creativehubkosovo" target="_blank"><img
                                src="img/FacebookLogo.png"></a>
                        <a href="https://www.linkedin.com/company/28931657" target="_blank"><img
                                src="img/LinkedinLogo.png"></a>
                        <a href="https://www.instagram.com/creativehubkosovo/?hl=en" target="_blank"><img
                                src="img/InstagramLogo.png"></a>
                    </li>
                </ul>
            </div>
            <div class="col-md-4 text-center">
